...
<section class="features">
    <div class="features__col1">
        ...
        <div class="features__card1">
            ${InfoCard({ image: INFO_CARD_1.image, title: INFO_CARD_1.title, description: INFO_CARD_1.description })}
        </div>
    </div>
    <div class="features__col2"> 
        <div class="features__card2"> 
            ${InfoCard({ image: INFO_CARD_2.image, title: INFO_CARD_2.title, description: INFO_CARD_2.description })}
        </div>
        <div class="features__card3"> 
            ${InfoCard({ image: INFO_CARD_3.image, title: INFO_CARD_3.title, description: INFO_CARD_3.description })}
        </div>
    </div>
</section>`;